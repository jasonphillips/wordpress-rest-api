...
function PostsRequest( options ) {
	 ...
	 * @type String
	 * @private
	 * @default '(/:postType)(/:id)(/:action)(/:actionId)'
	 */
...
PostsRequest.prototype._pathValidators = {
	...
	/**
	 * Action must be one of 'meta', 'comments', 'revisions', or 'terms'
	 *
...
/**
 * Specify that we are requesting the terms for a specific post and taxonomy
 *
 * @method terms
 * @chainable
 ...
 * @return {PostsRequest}
 */
PostsRequest.prototype.terms = function( taxonomyName ) {
	this._path.action = 'terms';
	this._path.actionId = taxonomyName;
	this._supportedMethods = [ 'head', 'get', 'delete' ];
