...
/**
 * Set the per request limit of a paged request.
 *
 * @method per_page
 * @chainable
 * @param {Number} pageLimit The number of results to retrieve per page
 * @return {CollectionRequest} The CollectionRequest instance (for chaining)
 */
CollectionRequest.prototype.per_page = function( pageLimit ) {
	return this.param( 'per_page', pageLimit );
};
