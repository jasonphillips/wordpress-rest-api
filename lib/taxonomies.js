...
function TaxonomiesRequest( options ) {
	 ...
	 * Default action of "taxonomies" unless requesting terms
	 *
	 * @property _path
	 * @type Object
	 * @private
	 ...
	 */
	this._template = '(:action)(/:taxonomy)(/:term)';
...
/**
 * Specify a term that should be the parent of the terms returned
 *
 * @method parent
 * @chainable
 * @return {TaxonomiesRequest} The TaxonomiesRequest instance (for chaining)
 */
TaxonomiesRequest.prototype.parent = function( termID ) {
	this._params.parent = termID;
	this._path.action = 'terms';
